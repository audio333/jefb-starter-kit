...
},{"process":"../../../../.npm-global/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/magnific-popup/dist/jquery.magnific-popup.js":[function(require,module,exports) {
var define;
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"../../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
function () {
  function Menu() {
    ...
    this.sectionOne = document.querySelector('.hero'); // Intersection Observer
    ...
    this.sectionOneObserver = new IntersectionObserver(function (entries, sectionOneObserver) {
      ...
      entries.forEach(function (entry) {
        if (!entry.isIntersecting) {
          _this.header.classList.add('nav-scrolled');
        } else {
          _this.header.classList.remove('nav-scrolled');
        }
      });
    }, this.sectionOneOptions);
    this.events();
...
},{}],"scripts/modules/ScrollToTop.js":[function(require,module,exports) {
"use strict";
    ...
    value: function events() {
      ...
      window.addEventListener("scroll", function () {
        if (window.pageYOffset > 100) {
          _this.toTop.classList.add("active");
        } else {
          _this.toTop.classList.remove("active");
        }
      });
    }
  }]);
...
exports.default = _default;
},{}],"scripts/modules/ScrollReveal.js":[function(require,module,exports) {
"use strict";
...
function () {
  function ScrollReveal() {
    ...
    this.scales = document.querySelectorAll('.scale-up'); // Intersection Observer
    ...
    this.appearOnScroll = new IntersectionObserver(function (entries, appearOnScroll) {
      entries.forEach(function (entry) {
        if (!entry.isIntersecting) {
          return; // entry.target.style.animation = `anim1 ${entry.target.dataset.delay} forwards ease-out`;
        } else {
  ...
  _createClass(ScrollReveal, [{
    ...
    value: function events() {
      ...
      this.faders.forEach(function (fader) {
        _this.appearOnScroll.observe(fader);
      });
      this.sliders.forEach(function (slider) {
        _this.appearOnScroll.observe(slider);
      });
      this.scales.forEach(function (scale) {
        _this.appearOnScroll.observe(scale);
      });
    }
  }]);
...
exports.default = _default;
},{}],"scripts/modules/MagnificPopup.js":[function(require,module,exports) {
"use strict";
...
function () {
  function MagnificPopup() {
    ...
    this.els = (0, _jquery.default)(".description");
    this.initPopup();
  }
...
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"scripts/index.js":[function(require,module,exports) {
"use strict";
...
var _ScrollToTop = _interopRequireDefault(require("./modules/ScrollToTop"));

var _ScrollReveal = _interopRequireDefault(require("./modules/ScrollReveal"));

var _MagnificPopup = _interopRequireDefault(require("./modules/MagnificPopup"));
...
var scrollReveal = new _ScrollReveal.default(); // var mobileMenu = new MobileMenu();
// var heroSlider = new HeroSlider();
// var lightbox2 = new Lightbox();

var magnificPopup = new _MagnificPopup.default();
},{"jquery":"../node_modules/jquery/dist/jquery.js","magnific-popup":"../node_modules/magnific-popup/dist/jquery.magnific-popup.js","../styles/main.scss":"styles/main.scss","@fortawesome/fontawesome-free/css/all.css":"../node_modules/@fortawesome/fontawesome-free/css/all.css","magnific-popup/src/css/main.scss":"../node_modules/magnific-popup/src/css/main.scss","./modules/Menu":"scripts/modules/Menu.js","./modules/ScrollToTop":"scripts/modules/ScrollToTop.js","./modules/ScrollReveal":"scripts/modules/ScrollReveal.js","./modules/MagnificPopup":"scripts/modules/MagnificPopup.js"}],"../../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/index.js"], null)
